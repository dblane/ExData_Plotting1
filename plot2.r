...
## Plot using the plot (?plot) function. Then we'll output to a .png file.
plot(dataselect$Global_active_power~dataselect$Datetime, type="l",ylab="Global Active Power (kilowatts)", xlab="")
